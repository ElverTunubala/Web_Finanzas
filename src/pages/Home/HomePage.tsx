...
import Layout from "../../components/Layouts/Public/Layout";  // Asegúrate de importar el Layout

const HomePage = () => {
  return (
    <Layout> {/* Envolvemos la página dentro del Layout */}
